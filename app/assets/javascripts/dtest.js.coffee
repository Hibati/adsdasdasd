test = ->
  ...
  getData = ->
    tbxValue = document.getElementById('txtf1').value
  ...
  loadData = ->
    ...
    $.getJSON 'http://iotser.iots.com.tw:3000/channels/' + channel_id + '/fields/1/last.json?api_key=' + api_key + '&timezone=Asia/Taipei', (data) ->
      # get the data point
      p = data.field1
      ...
      new_text = document.getElementById('txtf1').value
      new_num = document.getElementById('num').value
      if new_num >= new_text
        #document.bgColor = "pink";
        document.getElementById('ones').value = 1
        document.getElementById('txtf213').value = 'Open'
